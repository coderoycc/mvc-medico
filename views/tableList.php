  ...
  <div class="card-header border-0 pt-6">
    ...
    <div class="card-toolbar">
      ...
      <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
        ...
        <!--end::Export-->
        <!--begin::Add customer-->
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add
          Customer</button>
        <!--end::Add customer-->
      </div>
      <!--end::Toolbar-->
    ...
    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
      ...
      <tbody class="fw-bold text-gray-600">
        ...
        <tr>
          ...
          <!--begin::Payment method=-->
          <td data-filter="visa">
            <img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 9925
          </td>
          <!--end::Payment method=-->
          <!--begin::Date=-->
        ...
        <tr>
          ...
          <!--begin::Payment method=-->
          <td data-filter="mastercard">
            <img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 9166
          </td>
          <!--end::Payment method=-->
          <!--begin::Date=-->
        ...
        <tr>
          ...
          <!--begin::Payment method=-->
          <td data-filter="visa">
            <img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 4790
          </td>
          <!--end::Payment method=-->
          <!--begin::Date=-->
        ...
        <tr>
          ...
          <!--begin::Payment method=-->
          <td data-filter="american_express">
            <img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 5674
          </td>
          <!--end::Payment method=-->
          <!--begin::Date=-->
        ...
        <tr>
          ...
          <!--begin::Payment method=-->
          <td data-filter="american_express">
            <img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 9036
          </td>
          <!--end::Payment method=-->
          <!--begin::Date=-->
        ...
        <tr>
          ...
          <!--begin::Payment method=-->
          <td data-filter="visa">
            <img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 3579
          </td>
          <!--end::Payment method=-->
          <!--begin::Date=-->
        ...
        <tr>
          ...
          <!--begin::Payment method=-->
          <td data-filter="visa">
            <img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 2190
          </td>
          <!--end::Payment method=-->
          <!--begin::Date=-->
        ...
        <tr>
          ...
          <!--begin::Payment method=-->
          <td data-filter="mastercard">
            <img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 5785
          </td>
          <!--end::Payment method=-->
          <!--begin::Date=-->
        ...
        <tr>
          ...
          <!--begin::Payment method=-->
          <td data-filter="american_express">
            <img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 3469
          </td>
          <!--end::Payment method=-->
          <!--begin::Date=-->
