<div class="card">
  <div class="card-header border-0 pt-6">
    ...
    <div class="card-toolbar">
      <button type="button" class="btn btn-primary" data-bs-toggle="modal"
        data-bs-target="#kt_modal_add_customer">Agregar paciente</button>
  ...
  <div class="card-body pt-0">
    <table class="table align-middle table-row-dashed fs-6 gy-5" id="t_pacientes">
      <thead>
        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
          <th class="w-10px pe-2">
            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
              <input class="form-check-input" type="checkbox" data-kt-check="true"
                data-kt-check-target="#t_pacientes .form-check-input" value="1" />
            </div>
          </th>
          <th class="min-w-30px">ID</th>
          <th class="min-w-125px">NOMBRE</th>
          <th class="min-w-125px">FECHA NAC.</th>
          <th class="min-w-125px">SEXO</th>
          <th class="min-w-125px">TIPO SANGRE</th>
          <th class="min-w-125px">TELÉFONOS</th>
      ...
      <tbody class="fw-bold text-gray-600">
        <tr>
          ...
          <td>PCT-1</td>
          <td>
            <a href="./?page=paciente&nid=1" class="text-gray-800 text-hover-primary mb-1">Emma
              Smith</a>
          </td>
          <td>12/06/2000</td>
          <td>FEMENINO</td>
          ...
          <td>
            <a href="#" class="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="click"
              data-kt-menu-placement="bottom-end">Opciones
            ...
            <div
              ...
              <div class="menu-item px-3">
                <a href="#" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Editar</a>
              </div>
              <div class="menu-item px-3">
                <a href="#" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Eliminar</a>
              </div>
              <div class="menu-item px-3">
                <a href="#" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Consulta</a>
              </div>
              <div class="menu-item px-3">
                <a href="#" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Historial</a>
              </div>
              <div class="menu-item px-3">
                <a href="#" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Imprimir Receta</a>
              </div>
              <div class="menu-item px-3">
                <a href="#" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Crear cita</a>
              </div>
            </div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>PCT-1</td>
          <td>
            <a href="./?page=paciente&nid=1" class="text-gray-800 text-hover-primary mb-1">Roberto Carlos</a>
          </td>
          <td>12/06/2000</td>
          <td>FEMENINO</td>
          <td>O Rh+</td>
