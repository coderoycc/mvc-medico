<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
  ...
  <div class="aside-logo flex-column-auto" id="kt_aside_logo">
    <a href="./">
      <img alt="Logo" src="./views/assets/media/logos/logo-medic.png" class="h-25px logo" />
    </a>
    <!--begin::Aside toggler-->
  ...
  <div class="aside-menu flex-column-fluid">
    ...
    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
      ...
      <div
        ...
        <div class="menu-item">
          <a class="menu-link active" id="pg-pacientes" href="./?page=pacientes">
        ...
        <!-- <div class="menu-item">
         ...
         -->
        <div class="menu-item">
          <a class="menu-link" href="./?page=citas" id="pg-citas">
            <span class="menu-icon">
        ...
        <div class="menu-item">
          <div class="menu-content pt-8 pb-2">
            <span class="menu-section text-muted text-uppercase fs-8 ls-1">CONSULTAS</span>
          </div>
        </div>
